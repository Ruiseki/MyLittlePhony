 ...
 */
final class Version20221103155744 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE skills (id INT AUTO_INCREMENT NOT NULL, jobs_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, INDEX IDX_D531167048704627 (jobs_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
