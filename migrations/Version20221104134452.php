 ...
 */
final class Version20221104134452 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE profils_skills (profils_id INT NOT NULL, skills_id INT NOT NULL, INDEX IDX_7CF49BB7FF61858 (skills_id), INDEX IDX_7CF49BBB9881AFB (profils_id), PRIMARY KEY(profils_id, skills_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
